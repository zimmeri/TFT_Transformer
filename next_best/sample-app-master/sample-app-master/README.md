...
MYSTUFF
to run
-start up overwolf, sign in.
-if it doesn't pop up on load, hit the icon next to the discord emblem and select sample app
-sample app master/ sample app master/ ts / npm run build compiles code
- code is in native/windows/second-controller.js
okay im probably just going to have to set up a flask controller
